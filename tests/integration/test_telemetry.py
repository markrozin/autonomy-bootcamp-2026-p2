...
def stop(
    ...
    Parameters:
        ...
        output_queue: Queue to drain on shutdown.
    """
...
def read_queue(
    ...
    Parameters:
        output_queue: Queue to read telemetry data from.
    ...
    while not controller.is_exit_requested():
        try:
            ...
            telemetry_data = output_queue.queue.get(timeout=0.5)
            if telemetry_data is None:
                break
            main_logger.info(f"Worker output: {telemetry_data}")
